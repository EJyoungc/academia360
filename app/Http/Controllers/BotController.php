            ...
            case 'students':
                ...
                if ($classStudents->count() > 0) {
                    foreach ($classStudents as  $student) {
                        array_push($buttons, ['text' =>  $student->student->gender ? '👨'.$student->student->name : '👩'.$student->student->name , "callback_data" => "students  $student->student_id"]);
                    }
                    $buttonsInRow = 2;
                    $keyboard = [
