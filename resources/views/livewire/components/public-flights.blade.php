    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="input-group rounded-pill mb-3 shadow-sm p-3 bg-body rounded">
                ...
                <input type="text" class="form-control border-0  rounded-5 me-4 " placeholder="Search...">
            </div>
            ...
            <div class="col-sm-4">
                <a href="
                    ...
                    <div class="card1 card_three text-center">
                        <img src="{{ asset('assets/uploads/' . $item->image->image) }}" class="card-img-top img-style"
                            alt="...">
                        <div class="card-body">
                            <div class="title">

                                <h2 style="color:#10763cd1">{{ $item->name }}</h2>
                            </div>
                            <div class="price">
                                <h4><sup>Listings</sup>{{ $item->listings->count() }}</h4>
                            </div>
                            <div class="option">
                                <ul>
                                    <li>{{ $item->category->name }}
                                    </li>
                                    <li>{{ $item->district->name }}
                                    </li>
                    ...
                    <div class="card shadow bg-light">
                        <div class="card-body">
                            <div class="d-flex flex-column">
                                <div class="d-flex">
                                    <img src="{{ url('storage/' . $item->image->image) }}" width="100"
                                        height="100" alt="">
