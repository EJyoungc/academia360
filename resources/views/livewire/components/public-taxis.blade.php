    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="input-group rounded-pill mb-3 shadow-sm p-3 bg-body rounded">
                ...
                <input type="text" wire:model.prevent='search' class="form-control border-0  rounded-5 me-4 "
                    placeholder="Search...">
            </div>
    ...
    <div class="row  pt-3">
                    ...
                    <div class="card shadow bg-light">
                        <div class="card-body">
                            <div class="d-flex flex-column">
                                <div class="d-flex">
                                    <img src="{{ asset('assets/uploads/' . $item->image->image) }}" width="100"
                                        height="100" alt="">
        ...
        @empty
            <div class="col-lg-12 p-2">
                <div class="card shadow bg-light">
                    <div class="card-body">
                        <div class="h4 text-center text-muted">EMPTY</div>
                    </div>
                </div>
            </div>
        @endforelse
