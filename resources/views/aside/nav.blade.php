            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    ...
                    <b class="logo-icon">
                        ...
                        {{-- <h4>Academia</h4> --}}
                        <img src="{{ asset('dash/assets/images/logo-icon.png') }}" alt="" class="dark-logo" />
                        <!-- Light Logo icon -->
                        <img src="{{ asset('dash/assets/images/logo-light-icon.png') }}" alt=""
                            class="light-logo" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                    <span class="logo-text">
                        <!-- dark Logo text -->
                        {{-- <img src="{{ asset('dash/assets/images/logo-text.png') }}" alt="" class="dark-logo" /> --}}
                        <!-- Light Logo text -->
                        {{-- <h4>Academia</h4> --}}
                        {{-- <img src="{{ asset('dash/assets/images/logo-light-text.png') }}" class="light-logo"
                            alt="" /> --}}
                    </span>
                </a>
                <!-- ============================================================== -->
                ...
                <ul class="navbar-nav float-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="{{ asset('dash/assets/images/users/1.jpg') }}" alt="user"
